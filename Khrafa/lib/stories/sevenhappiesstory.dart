...
class SevenHappiesStory extends StatelessWidget {
  final int page;

  const SevenHappiesStory({Key key, this.page}) : super(key: key);
  @override
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Text(
                        ...
                        'يحكيو على زوز أخوة معرسين واحد عندو سبعة أولاد والثاني عندو سبعة بنات\n'
                        'توفات ام البنات وقعدوا البنيات حمل على كتاف بوهم   خوه الكبير يسافر مع اولادو ويجيب السلع ويبيع ويشري وحالتو ميسورة  لكن هو ما عرفش كيفاش يعمل  لا صاب يهزهم معاه ويسافر مع التجار   ولا قدر يخليهم ويمشي يشوف رزقو مع خوه\n'
                        ' مالقاش حتى حل غير انو يخدم عند خوه على خاطر من بعد موت المرحومة قلت حركت و وتجارتو وولى ياكل في الربح وراس المال\n'
                        'هوكة يحمل السلعة  يهز ويجيب قضيات  و يرد بالو على حوانت خوه كي يبدأ مسافر هو واولادو  عايش على قد الحال  ما يجوع ما يشبع  ساعات كي يستحق يطلب من خوه\n'
                      ),
                    ),
                  ],
                ),
