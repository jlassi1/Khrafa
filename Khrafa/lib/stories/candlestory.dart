...
class CandleStory extends StatelessWidget {
  final int page;

  const CandleStory({Key key, this.page}) : super(key: key);
  @override
                  ...
                  children: <Widget>[
                    Expanded(
                      ...
                      "تحير برشا هك سلطان على بنتة  وبعث لل طبٌّى في جميع العالم و الأسقاع "
                        "\n"
                        "لكن شيئ النافع ربي ولا من عندو ليها دواء"
                  ...
                  children: <Widget>[
                    Expanded(
                      ...
                      "و خذية مرا من اجمل النساء وإذا كتبلي ربي و خبت الموت خير من هالعيشة والحياة "
                        " .وقرر بينو و بين روحو باش يحاول "
                ...
                Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      ...
                      " و عد ايمات و ليلي  و هو يتفنن و يدوح في لراسو و خيط لها روبة من اجمل ما خيط و كيف لبسه لها  وتاتها بطريق مهولة "
                          ),
                    ),
                  ],
                ),
